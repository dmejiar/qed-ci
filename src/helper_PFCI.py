...
class PFHamiltonianGenerator:
    ...
    def parseArrays(self, cqed_rhf_dict):
        ...
        self.q_el_ao = cqed_rhf_dict["PF 1-E QUADRUPOLE MATRIX AO"]
        self.d_el_ao = cqed_rhf_dict["PF 1-E DIPOLE MATRIX AO"]
        ...
        self.mu_exp = self.mu_el + self.mu_nuc 
        ...
        # generate d in the cmo basis
        self.d_cmo = np.dot(self.C.T, self.d_el_ao).dot(self.C)
    ...
    def build1HSO(self):
        ...
        self.H_1e_ao = self.T_ao + self.V_ao + self.q_el_ao + self.d_nuc_d_el_ao
        # build H_spin
